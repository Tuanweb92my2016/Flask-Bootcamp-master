...
portfolio_value_string = '{:,}'.format(round(porfolio_value,2))
last_updated_string = datetime.fromtimestamp(last_updated).strftime('%B %d, %Y at %I:%M%p')

print("Total Porfolio Value : " + "$" + portfolio_value_string + Style.RESET_ALL)
print()
